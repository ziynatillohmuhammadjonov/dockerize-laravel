...
<head>
    ...
    <title> @yield('title') - Diamondlogistic company</title>
                            ...
                            <div class="col-xl-10 col-lg-6">
                                <div class="top-box-wrp d-flex justify-content-md-center align-items-center">
                                    <div class="top-box top-location mr-30">
                                        ...
                                        <span>121 Wallstreet Street, NY York, USA</span>
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="footer-widget about-us">
                        ...
                        <p class="mb-40">
                            ...
                            adipiscing elit, sed do eiusmod temp incididunt
                            ut labore et dolore magna aliqua. Quis ipsum
                            suspendisse ultrices gravida.
                        </p>
                        <div class="footer-bio">
                            <div class="footer-bio-pic">
                                <img src="assets/img/pictures/footer-bio.jpg" alt="no image">
                            </div>
    ...
    <div class="copyright py-5">
        <div class="container">
            <div class="copyright-element d-flex align-items-center justify-content-between">
                <p class="mb-0">Copyright 2023 Logtra . All Rights Reserved By Templatebucket</p>
